 ...
 */
export const ProductAnalytics = new Mongo.Collection("ProductAnalytics");

ProductAnalytics.attachSchema(Schemas.ProductAnalytics);
...
Translations.attachSchema(Schemas.Notifications);